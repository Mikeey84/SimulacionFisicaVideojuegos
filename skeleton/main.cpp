...
void initPhysics(bool interactive)
{
	...
	sParticleSystem->addGenerator(Generator::UNIFORM, PxVec3(0,0,0), 0.01, 10, 100, -5, 5, 50, 55, -5, 5, 10);
	...
	sParticleSystem->addForceGenerator(ParticleSystem::ForceType::GRAVITY, Vector3(0,0,0), Vector3(1000,1000,1000), Vector3(0, -10, 0));
	//Registers
